...
def cfg():
    ...
    if mode == 'train':
        ...
        batch_size = 8
        epoch = 40
        lr_milestones = [10000, 30000, 50000]
        align_loss_scaler = 0.1
        ignore_label = 255
        print_interval = 400
        save_pred_every = 400

        dataroot_support = './datasets/data_prostateX'
        dataroot_query = './datasets/data_prostateX'
        dataroot_test = './datasets/data_prostateX'
        snapshot = './runs/PANet_VOC_align_sets_0_1way_1shot_[train]/403/snapshots/best.pth'
        model = {
            'align': True,
        }
        ...
        notrain = False
        snapshot = './runs/PANet_VOC_align_sets_0_1way_1shot_[train]/414/snapshots/best.pth'
        dataroot_support = './datasets/data_prostateX'
        dataroot_test = './datasets/data_prostateX'
        n_runs = 1
        n_steps = 1000
    ...
    path = {
        'log_dir': './runs',
        'init_path': None,#'./runs/PANet_VOC_align_sets_0_1way_1shot_[train]/176/snapshots/best.pth',
